      ...
      <div className="navigation">
        <nav className="navBar">
          ...
          <div className="linkBtns">
            ...
            <button
              className="btn btn-outline-primary dropdown-toggle gear"
              type="button"
              id="dropdownMenuButton1"
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-wide btn-outline-primary" viewBox="0 0 16 16">
